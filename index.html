        ...
        <main class="flex-grow p-4 md:p-8">
            ...
            <section id="inventory-tab" class="tab-content mx-auto max-w-7xl">
                <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                    ...
                    <div class="mt-4 p-4 border border-gray-300 rounded-lg bg-gray-50 flex items-center justify-between space-x-4">
                        <div class="flex-grow">
    ...
    <script>
        ...
        const handleExcelUpload = () => {
            ...
            reader.onload = (e) => {
                ...
                renderInventory();
                showMessage(`Successfully uploaded! Added ${newItemsCount} new items and updated ${existingItemsCount} existing items.`, 'success', 'inventory-message');
